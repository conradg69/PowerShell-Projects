...
$downloadFolderDetailReports = "H:\SSRSBackupRefresh\ReportBackups\TR4_QAEFinance\$DetailReportsFolder $DateTimeFormatted"
...
Remove-RsCatalogItem -ReportServerUri $reportServerUriDest -RsItem "$RootFolderPath$SSRSUpdatedReportFolderQAEFinance/$SelectorReportsFolder" -Confirm:$false 
Remove-RsCatalogItem -ReportServerUri $reportServerUriDest -RsItem "$RootFolderPath$SSRSUpdatedReportFolderQAEFinance/$DetailReportsFolder" -Confirm:$false 
